...
type ListSummary struct {
	...
	ActionableAttentionCount int            `json:"actionable_attention_count,omitempty"`
	InformationalCount       int            `json:"informational_count,omitempty"`
	SessionTimeKnownRate     float64        `json:"session_time_known_rate,omitempty"`
	SessionTimeMatchRate     float64        `json:"session_time_match_rate,omitempty"`
	SessionTimeUnknownRate   float64        `json:"session_time_unknown_rate,omitempty"`
}
...
type PaneItem struct {
	...
	SessionTimeSource     string       `json:"session_time_source,omitempty"`
	SessionTimeConfidence float64      `json:"session_time_confidence,omitempty"`
